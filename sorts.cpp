...
#include "merge_bu_sort.h"
#include "quick_sort.h"
#include "quick_sort_3way.h"
#include "heap_sort.h"
...
test_sort_from_file<std::string>("quick_sort_3way", "equal_keys.txt", quick_sort_3way<std::string>());
    
test_sort_from_file<std::string>("quick_sort", "equal_keys.txt", quick_sort<std::string>());

  //  student::run_tests();

//  test_sort_from_file("heap_sort", "sort_example.txt", heap<std::string>());

test_sort_from_file<std::string>("heap_sort", "words3.txt", heap_sort<std::string>());
    
test_sort_from_file("heap_sort -- reversed", "words3.txt", heap_sort<std::string>(), rev_comparator<std::string>());
    
test_sort_from_file<std::string>("max_pq_heap", "words3.txt", max_pq_heap<std::string>());
